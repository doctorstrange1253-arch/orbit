...
import {
  ...
  SlidersHorizontal, LogOut, Lock, Radar, Coins, Crown, Store as StoreIcon, TrendingUp, Video, Calendar,
} from 'lucide-react';
...
import SessionsAdmin from './pages/Sessions';
...
const SECTIONS = [
  ...
  { id: 'sessions', label: 'Sessions', Icon: Calendar, Comp: SessionsAdmin },
