...
const RatingModal = ({ isOpen, onClose, otherUser, callDuration }) => {
  ...
  const submitRatingMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      queryClient.invalidateQueries({ queryKey: ['ratings', otherUser._id] }); // PublicProfile reviews list
      queryClient.invalidateQueries({ queryKey: ['user-ratings', otherUser._id] }); // ratings modal list
