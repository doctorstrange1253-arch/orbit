...
const DirectVideoCall = ({ roomId, onEnd, otherUser, isCaller, autoBoard }) => {
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      // Stop any active screen-share capture too, or the OS/browser "sharing your
      // screen" indicator (and the capture itself) leaks after leaving the call.
          ...
          calls.map((call, i) => {
            ...
            return (
              <motion.div key={call._id}
                ...
                className="skill-card p-4 flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4"
              >
